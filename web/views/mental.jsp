...
<html>
    <head>
        ...
        <link href="public/assets/backend/css/mental.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <jsp:include page='layouts/navbar.jsp'></jsp:include>
       <!--content1-->
        <div id="content1">
           <div class="img"><img src="public/assets/backend/img/pink.jpeg" alt="bg"></div>
            <div class="quotes1">
                <div class="ijo"><img src="public/assets/backend/img/ijo.jpeg" alt="ijo" width="300" height="300"></div>
        ...
        <div id="content2">
            <div class="image"><img src="public/assets/backend/img/tumblr.jpg" alt="bg" width="100%" height="500"></div>
            <div class="quotes2">
                <h1>
        ...
        <!--content3-->
        <div id="content3">
            <div class="background"> <img src="public/assets/backend/img/pinkbg.png" alt="pink" width="1350" height="500"></div>
            <div class="ungu"> <img src="public/assets/backend/img/ungu.jpeg" alt="ungu" width="300" height="300"> </div>
            <div class="quotes3">
