...
<html>
    ...
    <body>
        ...
        <div id="content1">
            ...
            <div class="iconbk">
                <img src="../public/assets/pinkbg.png" alt="pinkbg" width="720" height="400">
            </div>
            <div class="iconbk2">
                <img src="../public/assets/line.png" alt="lineimg" width="350" height="350">
            </div>
            <div class="iconbk3"> 
                <img src="../public/assets/book2.jpg" alt="book2" width="300" height="380">
            </div>
            <div class="quotes1">
        ...
        <div id="content2">
            <div class="image">
                <div class="iconbk4">
                    <img src="../public/assets/pinkbg.png" alt="pinkbg" width="500" height="300">    
                    <div class="iconbk5">
                        <img src="../public/assets/flowerimg.png" alt="flowerimg" width="350" height="400">     
                    </div>
                    <div class="iconbk6">
                        <img src="../public/assets/book3.jpg" alt="book3" width="300" height="380">
                    </div>
                </div>
            </div>
            <div class="quotes2">
        ...
        <div id="content3">
            <div class="image2">
                <div class="iconbk7">
                    <img src="../public/assets/pinkbg.png" alt="pinkbg" width="900" height="400">
                </div>
                <div class="iconbk8">
                    <img src="../public/assets/line.png" alt="line" width="500" height="350">
                </div>
                <div class="iconbk9">
                    <img src="../public/assets/book1.png" alt="book3" width="300" height="380">
                </div>
            </div>
            <div class="quotes3">
