...
<html>
    <head>
        ...
        <link href="public/assets/backend/css/about.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
         <jsp:include page='layouts/navbar.jsp'></jsp:include>
        <!--content1-->
        <div id="content1">
            <img class="yoga" src="public/assets/backend/img/MentalYou-logo.png" alt="MentalYou-logo.png" width="420" height="420">
            <div class="quotes1">
        ...
        <div id="content2">
            <img src="public/assets/backend/img/7.png" alt="bg" width="1800" height="500">
            <div class="quotes2">
                <h1>
        ...
        <div class="gambar">
            <img src="public/assets/backend/img/selfterapi.jpeg" style="display: inline-block;" alt="girl" width="350" height="350">
